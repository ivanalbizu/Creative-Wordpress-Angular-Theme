...
function load_header_scripts() {
	if ( $GLOBALS['pagenow'] != 'wp-login.php' && !is_admin() ) {
		...
		wp_register_script('bootstrap', get_template_directory_uri() . '/lib/bootstrap/js/bootstrap.min.js', array( 'jquery' ), null, false);
		wp_enqueue_script('bootstrap');


		wp_enqueue_script('app', get_template_directory_uri() . '/js/angular/app.js', array( 'angular' ), null, true );
		wp_enqueue_script('page-factory', get_template_directory_uri() . '/js/angular/factories/page.factory.js', array( 'angular' ), null, true );
		wp_enqueue_script('about-factory', get_template_directory_uri() . '/js/angular/factories/about.factory.js', array( 'angular' ), null, true );
		wp_enqueue_script('service-factory', get_template_directory_uri() . '/js/angular/factories/service.factory.js', array( 'angular' ), null, true );
		wp_enqueue_script('work-factory', get_template_directory_uri() . '/js/angular/factories/work.factory.js', array( 'angular' ), null, true );
		wp_enqueue_script('home-ctrl', get_template_directory_uri() . '/js/angular/controllers/home.controller.js', array( 'angular' ), null, true );
		wp_enqueue_script('about-ctrl', get_template_directory_uri() . '/js/angular/controllers/about.controller.js', array( 'angular' ), null, true );
		wp_enqueue_script('service-ctrl', get_template_directory_uri() . '/js/angular/controllers/service.controller.js', array( 'angular' ), null, true );
		wp_enqueue_script('work-ctrl', get_template_directory_uri() . '/js/angular/controllers/work.controller.js', array( 'angular' ), null, true );
		wp_enqueue_script('contact-ctrl', get_template_directory_uri() . '/js/angular/controllers/contact.controller.js', array( 'angular' ), null, true );
		wp_enqueue_script('footer-ctrl', get_template_directory_uri() . '/js/angular/controllers/footer.controller.js', array( 'angular' ), null, true );
...
function load_styles() {
	...
	wp_register_style('bootstrap', get_template_directory_uri() . '/lib/bootstrap/css/bootstrap.min.css', array(), null, 'all');
...
function create_custom_post_types() {
	...
	create_post_type( 'works', array('works'), 'works', 'Work', 'Works', array( 'title', 'editor', 'thumbnail' ), true );
	register_taxonomy( 'works_category', 'works', $taxonomy_args );
	register_taxonomy_for_object_type( 'works_category', 'works' );

	create_post_type( 'about', array('about'), 'about', 'About', 'About', array( 'title', 'thumbnail' ), true );

	create_post_type( 'service', array('service'), 'service', 'Service', 'Services', array( 'title', 'editor' ), true );
...
if ( is_plugin_active( 'rest-api/plugin.php' ) && is_plugin_active( 'advanced-custom-fields/acf.php' ) ) {
	...
	function slug_register_spaceship() {
		...
		// Return all fields create with ACF created for specified Post Type
		...
		register_rest_field( 'works',
				'post_categories',
				array(
						'get_callback'    => 'ng_get_categories_work',
						'update_callback' => null,
						'schema'          => null,
				)
		);
	...
	function ng_get_categories_work($post){
    $post_categories = array();
    $categories = wp_get_post_terms( $post['id'], 'work_category' );
